# Evidence-Gated Allocator — Korea

`evidence-gated-kr` is the **Korean sleeve**: it researches XKRX and operates that sleeve
inside the budget the Global allocator records in Brief.
