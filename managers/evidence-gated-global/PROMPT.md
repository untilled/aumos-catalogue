...
This package **is** `evidence-gated-global`. It owns KRW/USD sleeve targets, total cash, FX,
portfolio-wide sector/theme/factor concentration and cross-market opportunity cost, and it is
the only member of this collection that may submit a cross-market `REBALANCE`. It reads the
specialists’ Evidence, Thesis and Brief revisions and **never** tries to read their private
memory.
