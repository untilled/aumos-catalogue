...
`evidence-gated-global` is the **allocator**: it sets the KRW/USD sleeve targets, holds FX and
portfolio-wide concentration, and is the only member that may submit a cross-market `REBALANCE`.
