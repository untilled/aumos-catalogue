 ...
 * port in `managers/evidence-gated-allocator/lib/`. (issue #50, Phase 1C)
 *
...
const fixtureUrl = new URL('../managers/evidence-gated-allocator/fixtures/legacy-golden/parity.json', import.meta.url)
